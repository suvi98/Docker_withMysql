        ...
        <body>
            ...
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    ...
                    <ul class="navbar-nav">
                        <li><a href="<%=request.getContextPath()%>/book" class="nav-link">Users</a></li>
                    </ul>
                    <ul class="navbar-nav">
            ...
            <div class="container col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" name="add_user" action="<%=request.getContextPath()%>/update/book" align = "center">
                         <h3>Add User</h3>
                         <br>
                         <input hidden="hidden" name="bookid" value="${bookid}" type="text" /> 
