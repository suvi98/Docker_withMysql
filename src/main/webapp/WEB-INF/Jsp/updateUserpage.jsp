            ...
            <div class="container col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" name="add_user" action="<%=request.getContextPath()%>/updateUser" align = "center">
                         <h3>Add User</h3>
                         <br>
                         <input hidden="hidden" name="uid" value="${uid}" type="text" /> 
                        Name: <input name="uemail" value="${uemail}" type="text"  style="margin-right: -30px;" required/>     
                        <br /><br />
